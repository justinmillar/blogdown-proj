# Awesome function from Lorenzo Busetto
# https://lbusett.netlify.app/post/automatically-importing-publications-from-bibtex-to-a-hugo-academic-blog/

# Be sure that the bibtex file is updated and in the correct path
...
my_bibfile <- "static/personal-pubs.bib"
